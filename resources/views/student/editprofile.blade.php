      ...
      <div class="col-xl-8 order-xl-1">
        <div class="card bg-secondary shadow">
          ...
          <div class="card-body">
              ...
              <form action="{{route('student.updateDetails',['user'=>Auth::user()->id])}}" method="POST" class="pb-5">                         
                @method('PATCH')
                ...
                <div class="form-group row">
                    <div class="input-group input-group-alternative mb-3">
                        ...
                        <input id="DOB" type="date" placeholder="Date of Birth" class="form-control @error('DOB') is-invalid @enderror" name="DOB" value="{{ old('DOB') ?? Auth::user()->DOB }}" required autocomplete="DOB">
                        @error('DOB')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
